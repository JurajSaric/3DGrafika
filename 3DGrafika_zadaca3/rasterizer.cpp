...
int main(){
    ...
    draw_triangle_2d(image, 300, 300, 450, 450, 100, 450, blue);
    draw_triangle_2d(image, 50, 100, 200, 300, 400, 100, red);

    draw_triangle_2d_gouraurd(image, 20, 30, red, 460, 280, green, 100, 500, blue);
